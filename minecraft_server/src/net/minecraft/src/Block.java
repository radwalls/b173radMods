...
public class Block {
	...
	public static final Block repelRope = (new BlockRepelRope(97, 8)).setHardness(0.2F).setStepSound(soundClothFootstep).setBlockName("repelRope").disableStats().setRequiresSelfNotify();
