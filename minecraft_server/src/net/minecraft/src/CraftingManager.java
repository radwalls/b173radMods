...
public class CraftingManager {
	...
	private CraftingManager() {
		...
		this.addRecipe(new ItemStack(Block.dispenser, 1), new Object[]{"I#I", "TXT", "IRI", Character.valueOf('#'), Block.obsidian, Character.valueOf('X'), Item.bow, Character.valueOf('R'), Item.redstone, Character.valueOf('I'), Item.ingotIron, Character.valueOf('T'), Block.tnt});
