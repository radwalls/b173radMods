...
public class RecipesCrafting {
	public void addRecipes(CraftingManager var1) {
		...
		var1.addRecipe(new ItemStack(Item.spyglass), new Object[]{"PPP", "GII", Character.valueOf('P'), Block.planks, Character.valueOf('G'), Block.glass, Character.valueOf('I'), Item.ingotIron});
	}
}
