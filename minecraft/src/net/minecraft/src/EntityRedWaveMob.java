	...
	protected void updatePlayerActionState() {
		...
		if(this.ticksExisted % 30 == 0) {
			...
			if(var1 != null) {
				...
				if(var3 != null && this.getDistanceSq((double)var3.x, this.posY, (double)var3.z) > 100.0D) {
					PathEntity var4 = this.worldObj.getEntityPathToXYZ(this, var3.x, MathHelper.floor_double(this.posY), var3.z, 48.0F);
					if(var4 != null) {
		...
		if(this.isCollidedHorizontally && this.playerToAttack != null) {
			...
			if(this.breachTicks >= this.getBreachingDelay()) {
				...
				if(var4 > 0 && this.canBreakBlock(var4)) {
					this.worldObj.func_28106_e(2001, var1, var2, var3, var4 + this.worldObj.getBlockMetadata(var1, var2, var3) * 256);
