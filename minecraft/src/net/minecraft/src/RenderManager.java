...
public class RenderManager {
	...
	private RenderManager() {
		...
		this.entityRenderMap.put(EntitySeagull.class, new RenderBird(new ModelChicken(), 0.3F));
		this.entityRenderMap.put(EntityCrow.class, new RenderBird(new ModelChicken(), 0.3F));
		this.entityRenderMap.put(EntityHawk.class, new RenderBird(new ModelChicken(), 0.35F));
