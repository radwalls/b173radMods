...
public class RenderManager {
	...
	private RenderManager() {
		...
		this.entityRenderMap.put(EntityWaveCreeper.class, new RenderWaveCreeper());
		...
		this.entityRenderMap.put(EntityWaveZombie.class, new RenderWaveZombie(new ModelZombie(), 0.5F));
