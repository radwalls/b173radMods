...
public class EntityList {
	...
	static {
		...
		addMapping(EntityRedWaveZombie.class, "RedWaveZombie", 96);
		addMapping(EntityRedWaveSpider.class, "RedWaveSpider", 97);
		addMapping(EntityRedWaveCreeper.class, "RedWaveCreeper", 98);
