...
public class Block {
	...
	public static final Block dispenser = (new BlockDispenser(23)).setHardness(3.5F).setStepSound(soundStoneFootstep).setBlockName("cannon").disableNeighborNotifyOnMetadataChange();
