...
public class CraftingManager {
	...
	private CraftingManager() {
		...
		this.addRecipe(new ItemStack(Item.spyglass, 1), new Object[]{"PIP", " G ", "PI ", Character.valueOf('P'), Block.planks, Character.valueOf('I'), Item.ingotIron, Character.valueOf('G'), Block.glass});
