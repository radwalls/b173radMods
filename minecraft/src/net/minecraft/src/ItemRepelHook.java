	...
	public ItemStack onItemRightClick(ItemStack var1, World var2, EntityPlayer var3) {
		...
		if(var24 == null) {
			...
			if(!var2.func_6466_a(var3, var25, var26, var27)) {
				...
				if(var24.sideHit < 2 || var24.sideHit > 5) {
					return var1;
				}
				...
				while(var29 >= 0 && var2.isAirBlock(var25, var29, var27) && Block.ladder.canPlaceBlockAt(var2, var25, var29, var27)) {
					var2.setBlockWithNotify(var25, var29, var27, Block.ladder.blockID);
					var2.setBlockMetadataWithNotify(var25, var29, var27, var24.sideHit);
					++var28;
					--var29;
				}

				return var28 > 0 ? new ItemStack(Item.bucketEmpty) : var1;
			}
		}
	}
}
