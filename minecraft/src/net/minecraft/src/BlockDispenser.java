...
public class BlockDispenser extends BlockContainer {
	...
	public void onBlockAdded(World var1, int var2, int var3, int var4) {
		...
		this.populateCannonInventory(var1, var2, var3, var4);
	}
	...
	private void populateCannonInventory(World var1, int var2, int var3, int var4) {
		...
		if(var5 != null) {
			...
			for(int var7 = 0; var7 < var5.getSizeInventory(); ++var7) {
				if(var5.getStackInSlot(var7) != null) {
					var6 = false;
					break;
				}
			}
			...
			if(var6) {
				var5.setInventorySlotContents(0, new ItemStack(Block.tnt.blockID, 64, 0));
				var5.setInventorySlotContents(1, new ItemStack(Item.arrow.shiftedIndex, 64, 0));
				var5.setInventorySlotContents(2, new ItemStack(Item.egg.shiftedIndex, 64, 0));
				var5.setInventorySlotContents(3, new ItemStack(Item.snowball.shiftedIndex, 64, 0));
			}
		}
	}
